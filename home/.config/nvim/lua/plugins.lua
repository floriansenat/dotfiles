return {
  ...
  { 'shortcuts/no-neck-pain.nvim', version = '*', keys = {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function()
          ...
          vim.keymap.set('n', 'gD', builtin.lsp_type_definitions, { desc = 'Go to Declaration' })
          vim.keymap.set('n', 'gI', builtin.lsp_implementations, { desc = 'Go to Implementation' })
          vim.keymap.set('n', 'gA', builtin.lsp_references, { desc = 'See All references' })
