...
Write the final PRD to `<feature>/requirements.md` only after explicit user validation. End the document with a `Sources` section listing any web or document sources used.
